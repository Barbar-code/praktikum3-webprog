...
<div class="card form-card">
    ...
    <div class="card-body">
        <form action="index.php?action=edit&id=<?= $book['id'] ?>" method="POST" id="bookForm" novalidate>
            <div class="form-grid">
                ...
                <div class="form-group <?= isset($errors['genre']) ? 'has-error' : '' ?>">
                    ...
                    <select id="genre" name="genre" class="form-control">
                        ...
                        <option value="<?= $g ?>" <?= $book['genre'] === $g ? 'selected' : '' ?>>
                            <?= $g ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group <?= isset($errors['stock']) ? 'has-error' : '' ?>">
                    ...
                    <input type="number" id="stock" name="stock" class="form-control"
                           min="0" value="<?= htmlspecialchars($book['stock']) ?>">
                ...
                <div class="form-group full-width">
                    ...
                    <textarea id="description" name="description" class="form-control" rows="4"
                              placeholder="Short synopsis or notes..."><?= htmlspecialchars($book['description'] ?? '') ?></textarea>
                </div>
            </div>
